...
datDP <- NULL;
arrFiles<- Sys.glob("/data/projects/rcui/bahaha_assembly/wgs/gatk/slidingwin_DP_5kb_1kb_chr10/*.DP.win.txt")
...
write.table(datDPNoNA, file = "m.f.dp_diff.5kb.chr10.plot.tsv", sep = "\t", quote = F, col.names = T, row.names = F)
pdf(file="m.f.dp_diff.5kb.chr10.plot.pdf", width = 20, height = 5)
for(nChr in 10) {
