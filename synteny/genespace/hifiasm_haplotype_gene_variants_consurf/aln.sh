...
bash filter_paf_onlyhomchr.sh pairwise.aln.$sp1.$sp2.paf > pairwise.aln.$sp1.$sp2.filteredhomologchr.paf

#cut -f1,3,4,5,6,8,9,12 pairwise.aln.$sp1.$sp2.paf | awk '$8>=60 {print}' > pairwise.simp.$sp1.$sp2.txt
cut -f1,3,4,5,6,8,9,12 pairwise.aln.$sp1.$sp2.filteredhomologchr.paf  | awk '$8>=60 {print}' > pairwise.simp.$sp1.$sp2.filteredhomologchr.txt

( $paftools call -s $sp2 -q 60 -f $genome1 -L10000 -l1000 pairwise.aln.$sp1.$sp2.filteredhomologchr.paf | bgzip -c | bcftools norm -w 99999999 -O z -f $genome1  - > out.$sp1.$sp2.vcf.gz ) 2>out.vcf.info
